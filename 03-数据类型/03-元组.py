...
"""
元组的特点：
	1.	不可变：一旦创建，元组的元素不能被修改、删除或添加。
	2.	有序：元组中的元素有固定的顺序，可以通过索引访问。
	3.	可以包含不同类型的数据：元组可以存储各种不同类型的元素，例如整数、字符串、列表等。
"""
...
通过索引来访问元组中的元素，索引从 0 开始，也可以使用负索引从末尾访问。
"""
